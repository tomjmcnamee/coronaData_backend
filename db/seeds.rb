...
DataQualityGrade.create!(id: 1, state_id: 1, state: "AL")
DataQualityGrade.create!(id: 2, state_id: 2, state: "AK")
DataQualityGrade.create!(id: 3, state_id: 3, state: "AZ")
DataQualityGrade.create!(id: 4, state_id: 4, state: "AR")
DataQualityGrade.create!(id: 5, state_id: 5, state: "CA")
DataQualityGrade.create!(id: 6, state_id: 6, state: "CO")
DataQualityGrade.create!(id: 7, state_id: 7, state: "CT")
DataQualityGrade.create!(id: 8, state_id: 8, state: "DE")
DataQualityGrade.create!(id: 9, state_id: 9, state: "FL")
DataQualityGrade.create!(id: 10, state_id: 10, state: "GA")
DataQualityGrade.create!(id: 11, state_id: 11, state: "HI")
DataQualityGrade.create!(id: 12, state_id: 12, state: "ID")
DataQualityGrade.create!(id: 13, state_id: 13, state: "IL")
DataQualityGrade.create!(id: 14, state_id: 14, state: "IN")
DataQualityGrade.create!(id: 15, state_id: 15, state: "IA")
DataQualityGrade.create!(id: 16, state_id: 16, state: "KS")
DataQualityGrade.create!(id: 17, state_id: 17, state: "KY")
DataQualityGrade.create!(id: 18, state_id: 18, state: "LA")
DataQualityGrade.create!(id: 19, state_id: 19, state: "ME")
DataQualityGrade.create!(id: 20, state_id: 20, state: "MD")
DataQualityGrade.create!(id: 21, state_id: 21, state: "MA")
DataQualityGrade.create!(id: 22, state_id: 22, state: "MI")
DataQualityGrade.create!(id: 23, state_id: 23, state: "MN")
DataQualityGrade.create!(id: 24, state_id: 24, state: "MS")
DataQualityGrade.create!(id: 25, state_id: 25, state: "MO")
DataQualityGrade.create!(id: 26, state_id: 26, state: "MT")
DataQualityGrade.create!(id: 27, state_id: 27, state: "NE")
DataQualityGrade.create!(id: 28, state_id: 28, state: "NV")
DataQualityGrade.create!(id: 29, state_id: 29, state: "NH")
DataQualityGrade.create!(id: 30, state_id: 30, state: "NJ")
DataQualityGrade.create!(id: 31, state_id: 31, state: "NM")
DataQualityGrade.create!(id: 32, state_id: 32, state: "NY")
DataQualityGrade.create!(id: 33, state_id: 33, state: "NC")
DataQualityGrade.create!(id: 34, state_id: 34, state: "ND")
DataQualityGrade.create!(id: 35, state_id: 35, state: "OH")
DataQualityGrade.create!(id: 36, state_id: 36, state: "OK")
DataQualityGrade.create!(id: 37, state_id: 37, state: "OR")
DataQualityGrade.create!(id: 38, state_id: 38, state: "PA")
DataQualityGrade.create!(id: 39, state_id: 39, state: "RI")
DataQualityGrade.create!(id: 40, state_id: 40, state: "SC")
DataQualityGrade.create!(id: 41, state_id: 41, state: "SD")
DataQualityGrade.create!(id: 42, state_id: 42, state: "TN")
DataQualityGrade.create!(id: 43, state_id: 43, state: "TX")
DataQualityGrade.create!(id: 44, state_id: 44, state: "UT")
DataQualityGrade.create!(id: 45, state_id: 45, state: "VT")
DataQualityGrade.create!(id: 46, state_id: 46, state: "VA")
DataQualityGrade.create!(id: 47, state_id: 47, state: "WA")
DataQualityGrade.create!(id: 48, state_id: 48, state: "DC")
DataQualityGrade.create!(id: 49, state_id: 49, state: "WV")
DataQualityGrade.create!(id: 50, state_id: 50, state: "WI")
DataQualityGrade.create!(id: 51, state_id: 51, state: "WY")
# DataQualityGrade.create!(id: 52, state_id: 52, state: "AS")
DataQualityGrade.create!(id: 53, state_id: 53, state: "PR")
# DataQualityGrade.create!(id: 54, state_id: 54, state: "VI")
# DataQualityGrade.create!(id: 55, state_id: 55, state: "GU")
# DataQualityGrade.create!(id: 56, state_id: 56, state: "MP")
